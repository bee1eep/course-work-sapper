...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Franklin Gothic Medium", 30.25F, System::Drawing::FontStyle::Bold));
			this->label1->Location = System::Drawing::Point(176, 24);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(132, 48);
			this->label1->TabIndex = 1;
			this->label1->Text = L"сапер";
			// 
			// button2
			// 
			...
			this->checkBox1->Text = L"отметить бомбу";
			...
			// button200
			// 
			this->button200->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->button200->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.25F));
			this->button200->Location = System::Drawing::Point(12, 24);
			this->button200->Name = L"button200";
			this->button200->Size = System::Drawing::Size(141, 47);
			this->button200->TabIndex = 101;
			this->button200->Text = L"О игре";
			this->button200->UseVisualStyleBackColor = true;
			this->button200->Click += gcnew System::EventHandler(this, &MyForm::button_information_about_game);
			// 
			// button201
			// 
			this->button201->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->button201->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.25F));
			this->button201->Location = System::Drawing::Point(355, 24);
			this->button201->Name = L"button201";
			this->button201->Size = System::Drawing::Size(112, 47);
			this->button201->TabIndex = 101;
			this->button201->Text = L"Об авторе";
			this->button201->UseVisualStyleBackColor = true;
			this->button201->Click += gcnew System::EventHandler(this, &MyForm::button_information);
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(513, 405);
